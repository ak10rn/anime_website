...
class Anime extends Component {
  state = {
    ...
    reviews: [
      {
        name: "anonymous",
        img: "http://placekitten.com/300/340",
      ...
      },
      {
        ...
        img: "http://placekitten.com/230/300",
  ...
  handleAddReview = () => {
    ...
    // receive new review and db ka lawda lassan
          ...
          <div className="anime-reviews d-flex flex-column">
            ...
            {this.state.reviews.map((review) => {
              return (
                ...
                >
                  <div key={review.id + "user"} className="d-flex flex-row">
                    <img
                      key={review.id + "img"}
                      src={review.img}
                      className="user-img"
